---
name: learn-quiz
description: Use when the user wants to deeply learn or be quizzed on a coding session or topic — incremental teaching with mastery checks before advancing, tracked in a running checklist doc.
---
